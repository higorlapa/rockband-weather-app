...
/// to save the date from [CurrentModel]
class CurrentSQLiteModel {
  static const String TABLE = "current_table";
  static const String FIELD_ID = "id"; //int
  static const String FIELD_CITY_ID = "city_id"; //int
  ...
  static const String FIELD_CITY_NAME = "city_name"; //String
